...
const TableSamplePrescriptions = ({
  ...
  const handleCreateEventAction = ({ start, end }: SlotInfo) => {
    router.push(
      `/prescriptions/prescriptions-new?dateRangeStart=${start.toISOString()}&dateRangeEnd=${end.toISOString()}`,
    );
  };
    ...
    <>
      ...
      {!showGrid && (
        <BigCalendar
          ...
          pathEdit={`/prescriptions/prescriptions-edit/?id=`}
          pathView={`/prescriptions/prescriptions-view/?id=`}
