...
const TransactionsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'TransactionID', title: 'transaction_id' },
    { label: 'PaymentDetails', title: 'payment_details' },
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_TRANSACTIONS');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          {hasCreatePermission && (
            <BaseButton
              className={'mr-3'}
              href={'/transactions/transactions-new'}
              color='info'
              label='New Item'
            />
          )}
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/transactions/transactions-table'}>
              Switch to Table
            </Link>
          </div>
        </CardBox>
