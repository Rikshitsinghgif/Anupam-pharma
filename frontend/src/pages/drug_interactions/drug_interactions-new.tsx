...
import { create } from '../../stores/drug_interactions/drug_interactionsSlice';
...
Drug_interactionsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_DRUG_INTERACTIONS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Drug_interactionsNew;
