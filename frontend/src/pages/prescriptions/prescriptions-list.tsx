...
const PrescriptionsTablesPage = () => {
  ...
  const [filters] = useState([
    { label: 'PrescriptionCode', title: 'prescription_code' },

    { label: 'IssueDate', title: 'issue_date', date: 'true' },
    { label: 'ExpiryDate', title: 'expiry_date', date: 'true' },

    { label: 'Pharmacist', title: 'pharmacist' },

    { label: 'PatientRecord', title: 'patient_record' },
  ]);
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/prescriptions/prescriptions-table'}>
              Switch to Table
            </Link>
          </div>
        </CardBox>
