...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.drug_interactions_organizations =
      await organizations.getDrug_interactions_organizations({
        transaction,
      });

    output.inventory_managers_organizations =
      await organizations.getInventory_managers_organizations({
        transaction,
      });

    output.medicine_vouchers_organizations =
      await organizations.getMedicine_vouchers_organizations({
        transaction,
      });

    output.patient_records_organizations =
      await organizations.getPatient_records_organizations({
        transaction,
      });

    output.pharmacists_organizations =
      await organizations.getPharmacists_organizations({
        transaction,
      });

    output.prescriptions_organizations =
      await organizations.getPrescriptions_organizations({
        transaction,
      });

    output.transactions_organizations =
      await organizations.getTransactions_organizations({
        transaction,
      });
